<template>
  <div class="full quotes-app">
    <TitleBar ref="title-bar" :portal="portal" @click="$emit('activated')" :uiAPI="uiAPI">
      Live Preview <span class="linker" @click="runIframe()">Reset</span> <span class="linker" @click="setSquare(portal)">Square</span> <span class="linker" @click="downloadFrame()">HTML</span><span class="linker" @click="getJSON()">JSON</span>
    </TitleBar>
