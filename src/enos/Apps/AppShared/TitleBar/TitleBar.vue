...
.minify{
  background-image: radial-gradient( circle farthest-corner at 10% 20%,  hsl(108, 100%, 50%) 0%, hsl(199, 100%, 50%) 90.1% );
  width: 17px;
  height: 17px;
  border-radius: 50%;
  position: absolute;
...
.close{
  background-image: radial-gradient( circle farthest-corner at 10% 20%,  hsl(36, 100%, 50%) 0%, hsl(0, 100%, 50%) 90.1% );
  width: 17px;
  height: 17px;
  border-radius: 50%;
  position: absolute;
