<template>
  <g>
    ...
    <text class="noselect" @click="$emit('removeBox', { box, inputs, outputs })" style="text-decoration: underline; cursor: pointer;"  :height="10" :x="3.5 + box.pos.x + 30 + 45 + 2" :y="3.5 + box.pos.y + 25 + 2" :fill="`url(#${uniq}disco-club)`">Remove</text>
