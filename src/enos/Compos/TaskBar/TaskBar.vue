  ...
  <div class="div">
    <div class="taskbar" :class="{ disconnected: isDisconnected }">
      <div class="taskbar-content">
        ...
        v-for="(ip, ipk) in uiAPI.portal.portals.slice().sort((a, b) => {
    ...
    <div class="start-menu" v-show="startMenu">
      ...
      <div class="start-content-div">
        <div class="start-content-div-margin">
          ...
          <!-- <div class="app-icon adder" @click="closeMenu(); uiAPI.portal.addWindow({ data: {}, appName: 'System', type: 'sys' })">
            System
          </div> -->
          <!-- <div class="app-icon adder" @click="closeMenu(); uiAPI.portal.addWindow({ data: {}, appName: 'YoTeach', type: 'yoteach' })">
            YoTeach
          </div>
          <div class="app-icon adder" @click="closeMenu(); uiAPI.portal.addWindow({ data: {}, appName: 'Note', type: 'note' })">
            NoteApp
          </div> -->

          <div :key="smi.name" v-for="smi in StartMenuItems" class="app-icon adder" @click="closeMenu(); uiAPI.portal.addWindow({ data: {}, appName: smi.windowTitle, type: smi.compoName })">
            {{ smi.windowTitle }}
          </div>
...
export default {
  ...
  data () {
    return {
      // socket: YoNet.socket,
      StartMenuItems: AppList.StartMenu(),
      startMenu: false,
      toggle3D: false
    }
  },
